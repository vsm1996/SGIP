...
const CommentLikeButton = ({ session, comment, postId, liked, setLiked, handleFetch, }: CommentLikeButtonProps) => {
  ...
  return (
    <button onClick={handleLike}>
      <svg xmlns="http://www.w3.org/2000/svg" fill={liked ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:fill-accent">
